...
$standardRateCalculator = new \Behavioral\Strategy\StandardRateTaxCalculator();
$reducedRateCalculator  = new \Behavioral\Strategy\ReducedTaxCalculator();

$accountant = new \Behavioral\Strategy\Accountant($standardRateCalculator);
